    ...
    appBar: CustomAppbar(
      ...
      leading: Padding(
        padding: EdgeInsets.symmetric(
          horizontal: 0.025 * getHeight(context),
        ),
        child: Icon(Icons.arrow_back,size: 0.020 * getHeight(context),)
      ),
      leadingWidth: 60 * getResponsive(context),
    ),
    body: SingleChildScrollView(
      padding: EdgeInsets.symmetric(
        horizontal: 32.0 * getResponsive(context),
      ),
      child: Column(
        ...
        children: [
          LabeledTextField(
            ...
            labelTextStyle: TextStyle(fontWeight: FontWeight.w700,fontSize:12 * getResponsiveText(context),color: AppTheme.getColor(context).onSurfaceVariant),
            hintTextStyle: TextStyle(fontWeight: FontWeight.w600,color: AppTheme.getColor(context).outline,fontSize: 14 * getResponsiveText(context)),
            hint: 'Type Here',
          ...
          Column(
            ...
            children: [
              ...
              CustomMobileNumberField(
                ...
                hintText: '1234567890',
                hintTextStyle: TextStyle(color: AppTheme.getColor(context).outline,fontWeight: FontWeight.w500),
                numberTextStyle: TextStyle(color: AppTheme.getColor(context).outline,fontWeight: FontWeight.w500),
