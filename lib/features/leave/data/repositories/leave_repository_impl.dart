...
class LeaveRepositoryImpl implements LeaveRepository {
  ...
  Future<Either<Failure, LeaveHistoryResponseEntity>> getLeaveHistoryNew(
      String monthName, String year,) async =>
      safeApiCall.execute(() async {
        // Await the response from the data source
  ...
  @override
  Future<Either<Failure, CommonResponseModelEntity>> addShortLeave(String date,
      String time, String reason,) async =>
      safeApiCall.execute(() async {
        // Await the response from the data source
  ...
  Future<Either<Failure, CommonResponseModelEntity>> deleteShortLeave(
      String shortLeaveId, String shortLeaveDate, String otherUserId,
  ...
  Future<Either<Failure, LeaveTypeResponseEntity>> getLeaveTypesWithData(
      String unitId, String useId, String userName, String currentYear,
      String appliedLeaveDate,) async =>
      safeApiCall.execute(() async {
        // Await the response from the data source
        final responseModel = await remoteDataSource.getLeaveTypesWithData(
          unitId, useId, userName, currentYear, appliedLeaveDate,);
        // Convert the Model to an Entity before returning
        return responseModel.toEntity();
      });
  ...
  @override
  Future<
      Either<Failure, CheckLeaveBalanceResponse>> getLeaveBalanceForAutoLeave(
      String userId, String leaveDate, String leaveId,) async =>
      safeApiCall.execute(() =>
          remoteDataSource.getLeaveBalanceForAutoLeave(
            userId, leaveDate, leaveId,),);
  ...
  Future<Either<Failure, CommonResponseModelEntity>> changeAutoLeave(
      String userId, String paid, String leaveTypeId, String leaveDate,
      String leaveDay, String extraDay, String isSpecialDay,
      String attendanceId, String leaveId, String leavePercentage,) async =>
      safeApiCall.execute(() async {
        // Await the response from the data source
  ...
  Future<Either<Failure, CommonResponseModelEntity>> changeSandwichLeave(
      String userId, String paid, String leaveId, String leaveName,
      String sandwichId, String unitId, String userFullName,
      String leavePercentage,) async =>
      safeApiCall.execute(() async {
        // Await the response from the data source
  ...
  Future<Either<Failure, CompOffLeaveResponseEntity>>
  getCompOffLeaves(String startDate, String endDate,) async =>
      safeApiCall.execute(() async {
