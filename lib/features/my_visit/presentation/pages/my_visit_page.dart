  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: selectedTabIndex == 0
        ...
        imageSize: Responsive.getWidth(66),
        innericonsize: Responsive.getResponsiveText(context) * 20,
        circleavataradius: Responsive.getWidth(22),
        innericonbgr: Colors.white,
        margin: EdgeInsets.only(right: Responsive.getWidth(10)),
