...
class SelectCustomDialog extends StatefulWidget {
  ...
  const SelectCustomDialog({
    required this.optionIds, required this.optionNames, required this.selectedId, required this.title, required this.onSelected, super.key,
...
class _SelectCustomDialogState extends State<SelectCustomDialog> {
  ...
  void initState() {
    ...
    filteredIndexes = List.generate(widget.optionNames.length, (index) => index);
        ...
        child: Container(
          ...
          child: Wrap(
            children: [
              ...
              SizedBox(height: 250, child: filteredIndexes.isEmpty
                    ? const Center(
                  child: Column(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return GestureDetector(
                      ...
                      child: Container(padding: const EdgeInsets.symmetric(vertical: 1),
                        child: Row(
                          children: [
                            Expanded(
                              child: Padding(
