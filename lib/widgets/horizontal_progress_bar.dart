...
class HorizontalColorfulProgressBar extends StatefulWidget {
  ...
  const HorizontalColorfulProgressBar({
    ...
    super.key,
    this.defaultColor = AppColors.gray,
    this.backgroundColor,
    this.borderRadius,
  });

  @override
  State<HorizontalColorfulProgressBar> createState() =>
      _HorizontalColorfulProgressBarState();
}

class _HorizontalColorfulProgressBarState
    extends State<HorizontalColorfulProgressBar> {
  late Timer _timer;
            ...
            ClipRRect(
              ...
              child: Row(
                children: List.generate(widget.totalSeconds, (i) {
                  final Color color = i < _elapsedSeconds
