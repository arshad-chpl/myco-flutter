...
class AppointmentResponseModel {
  ...
  final List<MyAppointmentModel>? myAppointments; // List of nested models
...
class MyAppointmentModel {
  ...
  final String? appointmentId; // Using String? as per other types
  ...
  /// Converts this nested data model to its corresponding domain entity.
