...
AllAssetsModel allAssetsModelFromJson(String str) => AllAssetsModel.fromJson(json.decode(str));
...
class AllAssetsModel {
    ...
    factory AllAssetsModel.fromJson(Map<String, dynamic> json) => _$AllAssetsModelFromJson(json);
...
class AssetsFile {
    ...
    factory AssetsFile.fromJson(Map<String, dynamic> json) => _$AssetsFileFromJson(json);
...
class BrandList {
    ...
    factory BrandList.fromJson(Map<String, dynamic> json) => _$BrandListFromJson(json);
